...
const short = [
  'Oi! 👋', 'Tudo bem? 🙂', 'Boa tarde! ☀️', 'Oi tudo bem? 😊', 'Olá! 😊', 'E aí! 👋',
  'Boa noite! 🌙', 'Como vai? 🙂', 'Tudo certo? 👍', 'Oi!', 'Olá!', 'E aí, tudo na paz? ✌️',
  'Bom dia! ☀️', 'Oii 😄', 'Fala! 👋', 'Salve! ✋', 'E aí, beleza? 😄', 'Tudo tranquilo? 🙂',
  'Oi, sumido(a)! 😄', 'Como você tá? 🙂', 'Opa, tudo bem? 👋', 'Ei, tudo certo por aí? 🙂',
  'Bom dia, tudo bem? ☀️', 'Oi oi 👋', 'E aí, novidades? 👀', 'Oi, tudo joia? 😊',
...
const long = [
  ...
  'Tô pensando em fazer uma viagem esse mês, ainda não decidi pra onde ir ✈️',
  'Nossa, faz tempo que a gente não se fala direito, como andam as coisas? 😊',
  'Hoje choveu bastante aqui, o trânsito ficou um caos total 🌧️',
  ...
  'Tô com vontade de comer alguma coisa diferente hoje, ainda não decidi o quê 🍽️',
