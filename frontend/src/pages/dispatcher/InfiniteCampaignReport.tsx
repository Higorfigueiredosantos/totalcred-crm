...
interface Props {
  ...
  onClose: () => void
  onExportCSV: (item: InfiniteCampaignItem) => void
                ...
                <div className="mt-5">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button onClick={() => onExportCSV(item)}
                      className="flex items-center gap-1 text-xs text-yellow-400 hover:text-yellow-300 px-2 py-1 rounded border border-yellow-700 hover:border-yellow-500">
