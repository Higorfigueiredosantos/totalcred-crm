        ...
        <div className="flex items-start justify-between p-5 border-b border-gray-800">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs px-2 py-0.5 bg-orange-900/40 text-orange-300 rounded-full">Relatório · Via Wuzapi (Beta)</span>
            </div>
                ...
                <div className="mt-5">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button onClick={() => onExportCSV(item)}
                      className="flex items-center gap-1 text-xs text-orange-400 hover:text-orange-300 px-2 py-1 rounded border border-orange-700 hover:border-orange-500">
